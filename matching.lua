...
local t = {
	...
	["C_AuctionHouse.GetNumReplicateItems"] = [=[Returns the number of auctions found by an [[C_AuctionHouse.ReplicateItems|ReplicateItems]] query.]=],
	["C_AuctionHouse.GetReplicateItemInfo"] = [=[Returns information about a specific auction from a [[C_AuctionHouse.ReplicateItems|ReplicateItems]] query.]=],
	["C_AuctionHouse.GetReplicateItemTimeLeft"] = [=[Returns the time left for an auction from a [[C_AuctionHouse.ReplicateItems|ReplicateItems]] query.]=],
