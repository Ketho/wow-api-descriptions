...
local t = {
	...
	["C_AuctionHouse.GetNumReplicateItems"] = [=[Returns the number of auctions found by an ReplicateItems query.]=],
	["C_AuctionHouse.GetReplicateItemInfo"] = [=[Returns information about a specific auction from a ReplicateItems query.]=],
	["C_AuctionHouse.GetReplicateItemTimeLeft"] = [=[Returns the time left for an auction from a ReplicateItems query.]=],
