...
local t = {
	...
	["C_AuctionHouse.GetTimeLeftBandInfo"] = [=[Determine the minimum and maximum possible time left for a specific time band.]=],
	["C_AuctionHouse.SendBrowseQuery"] = [=[Queries the auction house for a summary of available items.]=],
